      ...
      <div class="row mt-3" style="padding-right: 15px; padding-left: 15px;">
        ...
        <div class="col-sm-3">
          <div class="input-group flex-nowrap">
            ...
            <input id="searchData"type="text" class="form-control" placeholder="Arama.." aria-label="Username" aria-describedby="addon-wrapping">
            <button onclick="searcData()" class="btn btn-outline-primary" id="search">Ara</button>
          </div>
        </div>
