...
<div class="wrapper d-flex align-items-stretch">
  ...
  <div id="content" class="p-4 p-md-5">
    ...
    <div class="main-card mb-3 card mainCart">
      ...
      <form class="row p-3" id="stock_add_form">
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style="color: black"   id="st_id">Modal title</h5>
      ...
      <div class="modal-body">
        <div class="row ">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div style="color: black"  id="st_title" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">Alış Fiyatı</label>
            <div style="color: black" id="st_purchase_price" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">Satış Fiyatı</label>
            <div style="color: black" id="st_sell_price" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">Ürün Kodu</label>
            <div style="color: black" id="st_code" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">KDV</label>
            <div style="color: black" id="st_tax_value" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">Birim</label>
            <div style="color: black"  id="st_unit" class="form-text"></div>
          </div>

          <div class="col-md-3 mb-3">
            <label  class="form-label">Miktar</label>
            <h5 style="color: black"  id="st_quantity" class="form-text"></h5>
          </div>
          <div class="col-md-3 mb-3">
            <label  class="form-label">Detay</label>
            <h5 style="color: black "  id="st_detail" class="form-text"></h5>
          </div>
